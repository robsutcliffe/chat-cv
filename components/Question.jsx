...
export default function Question({ ask, question, setQuestion, thinking }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden flex-auto min-w-0 rounded-l bg-white">
        <Gradient
          theme="secondary"
          className="absolute pointer-events-none w-full h-full rounded-l opacity-50"
        >
          <div
            style={{ filter: "blur(3px)" }}
            className="m-1 bg-white w-full h-full"
          ></div>
        </Gradient>
        <input
          ref={inputRef}
